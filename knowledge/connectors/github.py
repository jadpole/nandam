...
from base.resources.aff_plain import AffPlain, BundlePlain
...
class GitHubRepository(BaseModel, frozen=True):
    ...
    def from_uri(uri: ResourceUri) -> "GitHubRepository | None":
        if (
            uri.subrealm in ("commit", "file", "repository")
...
async def _github_read_file_body(
    ...
    return ObserveResult(
        ...
        option_descriptions=locator.is_default_branch and mode == "markdown",
